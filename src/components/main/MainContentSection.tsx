  ...
  return (
    <section className="flex flex-col items-start gap-2.5 pt-2 pb-0 px-4 relative self-stretch w-full flex-[0_0_auto]">
      <article
        ...
        className="flex items-center gap-6 px-5 py-4 relative self-stretch w-full flex-[0_0_auto] bg-primary rounded-xl overflow-hidden cursor-pointer hover:opacity-90 transition-opacity">
